...
--- Buffers ---
keymap.set("n", "<Tab>", "<C-6>", { desc = "Buffer Prev" })
...
--- Yank --
keymap.set({ "v", "n" }, "yl", "y$", { desc = "Yank To End Line" }) -- yanks to end of line
keymap.set({ "v", "n" }, "yaf", "<cmd> %y+ <CR>", { desc = "Yank All Buffer" }) -- yank whole file
